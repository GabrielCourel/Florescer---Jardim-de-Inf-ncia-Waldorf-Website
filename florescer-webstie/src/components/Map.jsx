...
export default function GoogleMapsComponent() 
{
  ...
  // Hook que cria a referência entre o Marcador e a Janela
  ...
  return (
    ...
    <APIProvider apiKey={import.meta.env.VITE_GOOGLE_MAPS_API_KEY}>
      ...
      <div className="my-6 w-full h-100 rounded-xl overflow-hidden bg-rosa-claro shadow-lg shadow-black/40 meio:h-120 meio:my-10 laptop:h-140 4k:h-180 grande:h-220">
